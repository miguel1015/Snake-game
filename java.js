document.addEventListener('DOMContentLoaded', () => {
    ...
    const startGame = () => {
        ...
        grid.style = (stopGame ? "background-color:black" : "background-color:black")
    }
    ...
    grid.addEventListener('click', () => {
        if (!stopGame)
            ...
            interval = setInterval(moveOutcomes, intervalTime)
        grid.style = (stopGame ? "background-color:black)" : "background-color:white")
